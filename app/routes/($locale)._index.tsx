      ...
      <Layout>
        ...
        <Gallery>
          <div className="gallery">
            <Gallery.Card
              id="modal-trigger-experience"
              animationAppearActive={true}
              photo={{
                url: assets.experience,
              }}
            />
            <Gallery.Card
              id="modal-trigger-skills"
              animationAppearActive={true}
              photo={{
                url: assets.skills,
              }}
            ...
            <Gallery.Card
              ...
              type="full"
              photo={{
                url: assets.works.default,
                loading: 'lazy',
                sources: [
                  {
                    media: 'small-screen',
                    srcSet: assets.works.small,
                  },
                  {
                    media: 'large-medium-screen',
                    srcSet: assets.works.default,
                  },
                ],
              }}
              onClick={() => (window.location.href = siteMap.works)}
            />
            <Gallery.Card
              id="modal-trigger-contact"
              animationAppearActive={true}
              type="full"
              photo={{
